    ...
    public class SaborDAO
    {
        ...
        public int Inserir(Sabor sabor)
        {
            ...
            try
            {
                ...
                foreach (Ingredientes auxIngrediente in sabor.SaborIngredientes)
                {
                    // salvar os ingredientes do sabor
                    comando.CommandText = @"INSERT INTO itens_sabores(sabor_id, ingrediente_id) VALUES (" + Convert.ToInt32(IdSaborGerado) + "," + auxIngrediente.IdIngrediente + ")";
        ...
        public DataTable Buscar(Sabor sabor)
        {
            ...
            "(SELECT STRING_AGG(i.descricao_ingrediente, ', ')FROM itens_sabores AS iss, cad_ingredientes i WHERE  iss.sabor_id = s.id_sabor AND i.id_ingrediente = iss.ingrediente_id ) AS Ingredientes " +
